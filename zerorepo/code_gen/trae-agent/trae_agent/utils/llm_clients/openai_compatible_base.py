...
class OpenAICompatibleClient(BaseLLMClient):
    ...
    def _create_response(
        ...
        self.client = self.provider_config.create_client(self.api_key, self.base_url, self.api_version)
        # print(token_params)
        return self.client.chat.completions.create(
            ...
            n=1,
            reasoning_effort="high" if "o4-mini" in model_config.model or "gpt-5" in model_config.model else openai.NOT_GIVEN,
            **token_params,
        )
